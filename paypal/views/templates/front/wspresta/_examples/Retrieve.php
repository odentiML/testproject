...
define('PS_SHOP_PATH', 'http://www.allezdiscount.com/_prestashop1610/');							// Root path of your PrestaShop store
define('PS_WS_AUTH_KEY', 'ZJKP2G77RJNFBTSGXKSPMASSUPQG63G9');	// Auth key (Get it in your Back Office)
